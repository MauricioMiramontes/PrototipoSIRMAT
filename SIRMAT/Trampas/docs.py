...
class docs_get():
    # Detalles de la documentacion para GET de Trampas
...
class docs_post():
    # Detalles de la documentacion para POST de Trampas
    ...
    body_valid = TrampaSerializer

#----------------------------------------------------------------------------------------

class docs_put():
    # Detalles de la documentacion para PUT de Trampas
...
class docs_delete():
    # Detalles de la documentacion para DELETE de Trampas
