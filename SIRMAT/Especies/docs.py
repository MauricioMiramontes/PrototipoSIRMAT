...
class docs_get():
    # Detalles de la documentacion para GET de Especies
...
class docs_post():
    # Detalles de la documentacion para POST de Especies
    ...
    body_valid = EspecieSerializer

#----------------------------------------------------------------------------------------

class docs_put():
    # Detalles de la documentacion para PUT de Especies
...
class docs_delete():
    # Detalles de la documentacion para DELETE de Especies
