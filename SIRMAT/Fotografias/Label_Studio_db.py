...
def agregar_foto_ls(id_foto, nombre_foto, id_usuario, id_proyecto):
    ...
    if os.path.exists(str(DIR) + '/frontend/src/Label_Studio_Data/label_studio.sqlite3'):
        # Se crea conexion a base de datos
        try: 
            con = sqlite3.connect(str(DIR) + '/frontend/src/Label_Studio_Data/label_studio.sqlite3')
            cur = con.cursor()
        except:
