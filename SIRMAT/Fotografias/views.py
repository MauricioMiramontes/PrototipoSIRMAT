...
from .serializers import FotografiaSerializer # Importamos el serializador del modelo Fotografia
...
class FotografiaAPI(APIView):
    ...
    def get(self, request, format=JsonResponse):
        ...
        if request.query_params: #Revisamos si hay o no parametros dentro de la peticion HTTP
            ...
            try: fotografia = Fotografia.objects.get(idFotografias = request.query_params['id'])
    ...
    def post(self, request):
        ...
        if serializer.is_valid(): #Si la peticion es valida 
            ...
            agregar_foto_ls(
                ...
                1, # To Do: Cambiar esto por el id de usuario de la sesion
