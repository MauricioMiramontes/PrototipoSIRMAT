...
from .serializers import EstereoscopioSerializer #Importamos el serializador del modelo Estereoscopio
...
class EstereoscopiosAPI(APIView):
    ...
    def put(self, request):
        ...
        if request.query_params: #Revisamos si hay o no parametros dentro de la peticion HTTP
            ...
            serializer = EstereoscopioSerializer(estereoscopio, data = request.data)
